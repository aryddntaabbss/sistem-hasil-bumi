...
class DummyDataSeeder extends Seeder
{
    public function run(): void
    {
        // Data Petani
        $petanis = [
            ['nama' => 'Ahmad Basir',    'alamat' => 'Desa Gane Luar, Kec. Gane Barat',  'no_hp' => '081234567801'],
            ['nama' => 'Siti Rahmawati', 'alamat' => 'Desa Gane Dalam, Kec. Gane Barat', 'no_hp' => '081234567802'],
            ['nama' => 'Umar Djalil',    'alamat' => 'Desa Jikomalamo, Kec. Gane Barat', 'no_hp' => '081234567803'],
            ['nama' => 'Fatima Soleman', 'alamat' => 'Desa Gane Luar, Kec. Gane Barat',  'no_hp' => '081234567804'],
            ['nama' => 'Ruslan Hamid',   'alamat' => 'Desa Gane Dalam, Kec. Gane Barat', 'no_hp' => '081234567805'],
            ['nama' => 'Halima Usman',   'alamat' => 'Desa Jikomalamo, Kec. Gane Barat', 'no_hp' => '081234567806'],
            ['nama' => 'Ibrahim Saleh',  'alamat' => 'Desa Gane Luar, Kec. Gane Barat',  'no_hp' => '081234567807'],
            ['nama' => 'Nurhayati Malik','alamat' => 'Desa Gane Dalam, Kec. Gane Barat', 'no_hp' => '081234567808'],
        ];

        foreach ($petanis as $p) {
            Petani::firstOrCreate(['nama' => $p['nama']], $p);
        }
        ...
        foreach ($komoditas as $k) {
            Komoditas::firstOrCreate(['nama_komoditas' => $k['nama_komoditas']], $k);
        }
